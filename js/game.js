(() => {
  ...
  const bootLines = [
    ...
    'Version 0.7.2 // VECTOR CELL ART + WASD HOTFIX',
    'Initializing...',
  ...
  const STAGE_DEFS = {
    ...
    f003: {key:'f003', id:'F-003', title:'Neon Graveyard', chapter:'Chapter 3 // Dead Frequencies', levelReq:12, map:normalizeMapRows(stage3Map), threat:'HIGH // PREVIEW', objective:'grave signal terminal → spectral anomalies → signal boss → extraction', reward:'120 Credits, 2 Rust Cores, 2 Catalysts, rare gear preview', rewardCredits:120, rewardShards:7, clearXp:550, nextKey:null, bg:'assets/battle_backgrounds/neon_graveyard_battle.png'}
  };
