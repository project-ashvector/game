(() => {
  ...
  const BUILD_TITLE = 'BOSS INTEL PASS';
  const bootLines = [
...
,
  ...
  function openOverlay(id){
    ...
    try{
      ...
      if(id==='missionOverlay'){ renderUI(); renderMissionContractPanel(); renderStoryArchivePanel(); renderRouteRecordsPanel(); }
