...
> Main menu opens after the intro or if playback is blocked.`;
  ...
  const coreItemRegistry = [
    ...
    {id:'EQ-002', name:'Sewer Guard Vest', type:'Equipment', category:'Armor', slot:'Chest', rarity:'Common', stackSize:1, sellPrice:10, asset:'assets/items/custom/sewer_guard_vest.png', status:'dedicated-item-art', levelReq:1, stats:{def:2,hp:8}, desc:'A cleaned-up vest from an unlucky guard. Smells like plot progression.'},
    ...
    {id:'EQ-007', name:'Wasteland Guard Helm', type:'Equipment', category:'Armor', slot:'Helm', rarity:'Rare', stackSize:1, sellPrice:65, asset:'assets/items/custom/wasteland_guard_helm.png', status:'dedicated-item-art', levelReq:5, stats:{def:5,hp:18,ep:4}, desc:'Outpost helm with the HUD cracked but the skull protection still online.'},
    ...
    {id:'IT-020', name:'Ash Ore', type:'Material', category:'Mining', slot:'Stack', rarity:'Common', stackSize:999, sellPrice:3, asset:'assets/training/items/cryptomining/ash_ore.png', status:'field-skill-resource', desc:'Ore chipped from ash-veined salvage nodes. Used for future smithing and upgrade loops.'},
    ...
    {id:'IT-022', name:'Circuit Scrap', type:'Material', category:'Codecraft', slot:'Stack', rarity:'Common', stackSize:999, sellPrice:3, asset:'assets/training/items/codecraft/circuit_scrap.png', status:'field-skill-resource', desc:'Circuit fragments used for future codecraft and gear assembly.'},
    {id:'IT-023', name:'Mutagen Sample', type:'Material', category:'Forgenetics', slot:'Stack', rarity:'Rare', stackSize:999, sellPrice:8, asset:'assets/training/items/forgenetics/mutagen_sample.png', status:'field-skill-resource', desc:'Unstable bio sample harvested from corrupted growths.'},
