(() => {
  ...
  const BUILD_TITLE = 'DEDICATED ITEM ART PATCH';
  const bootLines = [
...
> Main menu opens after the intro or if playback is blocked.`;
  ...
  const TRAINING_ITEM_ASSETS = {
    "Ash Pebble": "assets/items/custom/v211/ash_pebble.png",
    "Ash Ore": "assets/items/custom/v211/ash_ore.png",
    "Dense Ash Ore": "assets/items/custom/v211/dense_ash_ore.png",
    "Vector Crystal": "assets/items/custom/v211/vector_crystal.png",
    "Obsidian Core Ore": "assets/training/items/cryptomining/obsidian_core_ore.png",
    "Static Packet": "assets/items/custom/v211/static_packet.png",
    "Encrypted Data": "assets/training/items/datafishing/encrypted_data.png",
    "Ghost Log": "assets/items/custom/v211/ghost_log.png",
    "Blackbox File": "assets/items/custom/v211/blackbox_file.png",
    "Deep Archive Packet": "assets/training/items/datafishing/deep_archive_packet.png",
    "Wire Scrap": "assets/items/custom/v211/wire_scrap.png",
    "Circuit Scrap": "assets/items/custom/v211/circuit_scrap.png",
    "Logic Board": "assets/items/custom/v211/logic_board.png",
    "Quantum Relay": "assets/items/custom/v211/quantum_relay.png",
    "Null Module Part": "assets/training/items/codecraft/null_module_part.png",
    "Spore Sample": "assets/items/custom/v211/spore_sample.png",
    "Mutagen Sample": "assets/items/custom/v211/mutagen_sample.png",
    "Mutated Tissue": "assets/items/custom/v211/mutated_tissue.png",
    "Vector DNA": "assets/items/custom/v211/vector_dna.png",
    "Ash Genome Strand": "assets/training/items/forgenetics/ash_genome_strand.png",
    "Broken Token": "assets/items/custom/v211/broken_token.png",
    "Access Fragment": "assets/training/items/system_hacking/access_fragment.png",
    "Security Keybit": "assets/items/custom/v211/security_keybit.png",
    "Root Cipher": "assets/items/custom/v211/root_cipher.png",
  ...
  const coreItemRegistry = [
    ...
    {id:'EQ-002', name:'Sewer Guard Vest', type:'Equipment', category:'Armor', slot:'Chest', rarity:'Common', stackSize:1, sellPrice:10, asset:'assets/items/custom/v211/sewer_guard_vest.png', status:'dedicated-item-art', levelReq:1, stats:{def:2,hp:8}, desc:'A cleaned-up vest from an unlucky guard. Smells like plot progression.'},
    ...
    {id:'EQ-007', name:'Wasteland Guard Helm', type:'Equipment', category:'Armor', slot:'Helm', rarity:'Rare', stackSize:1, sellPrice:65, asset:'assets/items/custom/v211/wasteland_guard_helm.png', status:'dedicated-item-art', levelReq:5, stats:{def:5,hp:18,ep:4}, desc:'Outpost helm with the HUD cracked but the skull protection still online.'},
    ...
    {id:'IT-020', name:'Ash Ore', type:'Material', category:'Mining', slot:'Stack', rarity:'Common', stackSize:999, sellPrice:3, asset:'assets/items/custom/v211/ash_ore.png', status:'dedicated-item-art', desc:'Ore chipped from ash-veined salvage nodes. Used for future smithing and upgrade loops.'},
    ...
    {id:'IT-022', name:'Circuit Scrap', type:'Material', category:'Codecraft', slot:'Stack', rarity:'Common', stackSize:999, sellPrice:3, asset:'assets/items/custom/v211/circuit_scrap.png', status:'dedicated-item-art', desc:'Circuit fragments used for future codecraft and gear assembly.'},
    {id:'IT-023', name:'Mutagen Sample', type:'Material', category:'Forgenetics', slot:'Stack', rarity:'Rare', stackSize:999, sellPrice:8, asset:'assets/items/custom/v211/mutagen_sample.png', status:'dedicated-item-art', desc:'Unstable bio sample harvested from corrupted growths.'},
