(() => {
  ...
  const BUILD_VERSION = '0.9.98';
  const BUILD_TITLE = 'LOCKDOWN ESCALATION + ROLL SYSTEM';
  const bootLines = [
...
,
  ...
  function chooseLockdownModifier(e){
    ...
    const debuffChance=Math.min(.42,.16+elapsed*.24);
