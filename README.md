...
## Developer Build 0.5 — Professional Project Structure

This build adds the long-term production structure for **Project: ASH VECTOR**. The game remains playable from the root `index.html` for GitHub Pages, while the project now includes documentation and planning files for a real indie-style workflow.
...
- `LICENSE.md`
- `credits/CREDITS.md`
- `engine/` placeholder modules
- `tools/` and `builds/` folders

The main rule remains: placeholder assets use the same filenames as the final art, so finished images can be swapped in later without changing code.


## Developer Build 1.0 — Branding Asset Pack

Added production branding file paths, logo/emblem assets, menu background, working CSS/JS, and production-ready asset replacement naming.

Current playable build includes AVOS boot, main menu, dungeon movement, operator/anomaly/inventory/fracture database screens, battles, loot, XP, saves, and branding assets.
